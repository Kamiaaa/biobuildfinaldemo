              ...
              <div className="relative">
                ...
                {openSubmenu === "about" && (
                  <div className="mt-2 ml-4 space-y-2">
                    ...
                    {/* <Link href="/management-team" onClick={() => setIsOpen(false)} className="block text-xl text-gray-700 hover:text-[#7AA859]">Management Team</Link> */}
            ...
            <div className="relative">
              ...
              {openSubmenu === "about" && (
                <div className="mt-2 ml-4 space-y-2">
                  ...
                  {/* <Link href="/management-team" className="block text-lg text-gray-700 hover:text-[#7AA859]">Management Team</Link> */}
