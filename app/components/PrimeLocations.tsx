...
export default function PrimeLocationsPage() {
  ...
  useEffect(() => {
    const fetchLocations = async () => {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/prime-locations?page=${page}&limit=${LIMIT}`, {
        cache: 'no-store',
      });
  ...
  return (
    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 py-5">
      ...
      <section className="px-4 text-center bg-white dark:bg-gray-800">
        <h2 className='text-4xl font-fondamento text-center mt-10 py-10'>
